...
export function DesignCard({ item }: { item: DesignCardItem }) {
  const cardInner = (
    <>
  ...
  return item.link ? (
    ...
    <div className="group flex flex-col h-full rounded-3xl overflow-hidden border border-fun-pink-dark hover:border-fun-pink-light transition-colors duration-300">
      {cardInner}
    </div>
  );
}
